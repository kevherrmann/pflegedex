...
export default function Edit({ staffUser, locations, roles }: StaffEditProps) {
    const { data, setData, patch, processing, errors } = useForm<{
        ...
        is_nursing_specialist: staffUser.employeeProfile?.isNursingSpecialist ?? false,
        qualification_level:
        ...
        annual_vacation_days: staffUser.employeeProfile?.annualVacationDays?.toString() ?? '30',
